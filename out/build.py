# python build stubs for package pycall
...
mod.add_function('pycall_Caller_CTor', retval('int64_t'), [])
mod.add_function('pycall_Caller_Iter_Get', retval('int64_t'), [param('int64_t', 'handle')])
mod.add_function('pycall_Caller_Iter_Set', None, [param('int64_t', 'handle'), param('int64_t', 'val')])
add_checked_function(mod, 'pycall_Caller_Start', None, [param('int64_t', '_handle'), param('PyObject*', 'f', transfer_ownership=False), param('bool', 'goRun')])
add_checked_function(mod, 'pycall_NewCaller', retval('int64_t'), [param('int64_t', 'n')])

mod.generate(open('pycall.c', 'w'))
